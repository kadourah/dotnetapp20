...
```
tanzu apps workload create dotnet-app-20 -f config/workload.yaml \
  --local-path . \
  --source-image <REPOSITORY-PREFIX>/dotnet-app-20-source \
  --type web
```
...
```
tanzu apps workload get dotnet-app-20
```
